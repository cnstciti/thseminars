...
class ResendVerificationEmailFormTest extends Unit
{
    ...
    public function testWrongEmailAddress()
    {
        ...
        expect($model->getFirstError('email'))->equals('Нет пользователя с этим адресом электронной почты.');
    }
    ...
    public function testSuccessfullyResend()
    {
        ...
        expect($mail->getSubject())->equals('Подтверждение регистрации на ' . \Yii::$app->name);
